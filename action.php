...
<html>
  ...
  <body>
    <?php
    echo "<div class = 'layui-panel layui-anim layui-anim-down' style = 'padding:2%; margin:2%;'><blockquote class = 'layui-elem-quote markdown-body'>".$_POST["html"]."</blockquote></div>";
    echo "<pre>".htmlspecialchars($_POST["html"])."</pre>";
    ?>
